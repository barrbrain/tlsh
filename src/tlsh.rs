    ...
    > TlshBuilder<EFF_BUCKETS, TLSH_CHECKSUM_LEN, CODE_SIZE, TLSH_STRING_LEN_REQ, MIN_DATA_LENGTH>
{
    ...
    pub fn update(&mut self, data: &[u8]) {
        ...
        let mut slide_window = u32::from_ne_bytes(self.slide_window);

        for b in data {
            let b_0 = *b;
            let [b_1, b_2, b_3, b_4] = slide_window.to_le_bytes();
            slide_window = (slide_window << 8) + u32::from(b_0);
        ...
        self.slide_window = slide_window.to_ne_bytes();
